// @jiso-ir — lowered from site/tutorial/steps/06-streaming/src/components/product-list.tsx by @jiso/compiler (SPEC.md section 5.2). Do not edit; regenerate with `node site/tutorial/run-steps.mjs --write`.
