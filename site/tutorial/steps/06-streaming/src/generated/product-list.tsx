...
const productListStyles = style.create(
  ...
  { namespace: 'tutorial-product-list', source: 'site/tutorial/steps/06-streaming/src/components/product-list.tsx' },
);

export const ProductList = component({
  queries: { products: productsQuery },
  render: ({ products }: { products: ProductsResult }, context: ProductListRenderContext = {}) => (
    <ul class="kv-tutorial-product-list-d-bqcudx kv-tutorial-product-list-gap-1uub0u kv-tutorial-product-list-pad-q603nn" data-style-src="site/tutorial/steps/06-streaming/src/components/product-list.tsx#list" kovo-c="product-list" kovo-deps="products" kovo-fragment-target="product-list" kovo-live-component="components/product-list/product-list">
