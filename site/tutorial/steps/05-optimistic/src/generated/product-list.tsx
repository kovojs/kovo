// @kovojs-ir — lowered from site/tutorial/steps/05-optimistic/src/components/product-list.tsx by @kovojs/compiler (SPEC.md section 5.2). Do not edit; regenerate with `node site/tutorial/run-steps.mjs --write`.
