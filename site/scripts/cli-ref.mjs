...
function renderReferencePage({ frontmatter, programmatic }) {
  ...
  return [
    ...
    '## Programmatic API',
    '',
    'The `@kovojs/cli` package also exposes a small one-shot semantic command, diagnostic, and',
    'in-process verifier surface. Callers name command concepts rather than argv flags, and',
    'one versioned diagnostic record can be rendered as human, JSON, or GitHub output',
    '(SPEC.md §11.4). This reference is',
