...
export type InferSchema<T> = T extends SnippetSchema<infer Value> ? Value : never;
...
export const cartSummaryQuery = {} as any;
...
export const productDetailQuery = {} as any;
