// Browser shim for the `@jiso/runtime` bare specifier used by compiled gallery
// client handler modules (`import { handler } from '@jiso/runtime'`). The site
// maps `@jiso/runtime` to this file via an import map (see chrome.mjs). `handler`
