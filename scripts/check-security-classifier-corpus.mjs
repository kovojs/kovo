...
export const REQUIRED_CLASSIFIER_CORPORA = [
  ...
  },
  {
    ...
    verdictAnchors: [
      ...
      {
        id: 'task-b-analysis-carrier-and-finite-diagnostic-census',
        file: 'packages/drizzle/src/trust-escapes-static.test.ts',
        snippets: [
          'binds every non-egress finite terminal to an independent same-source denominator',
          'retains $code in the hashed finite-diagnostic verdict',
          "code: 'KV450' as const",
          "code: 'KV452' as const",
          'analysisCarrierSha256',
          'blockingDiagnostics: []',
        ],
      },
      {
        id: 'task-b-complete-terminal-correspondence',
        file: 'packages/drizzle/src/trust-escapes-static.test.ts',
        snippets: [
          '@kovo-security-certifies C13 task-b-complete-terminal-correspondence',
          'binds every non-egress finite terminal to an independent same-source denominator',
          'componentTaskBSourceOperationFacts',
          'exactCompilerTaskBClosureProof(files, omittedSources)',
          'traces: [...root.traces, terminal]',
          'sink=compiler-route',
        ],
      },
      {
        id: 'same-file-root-reference-correspondence',
        file: 'packages/drizzle/src/trust-escapes-static.test.ts',
        snippets: [
          '@kovo-security-certifies C13 same-file-root-reference-correspondence',
          'joins one immutable same-file handler reference to its exact finite-IR root',
          'const saveHandler = (_input, request)',
          'export const save = mutation({ handler: saveHandler })',
          'exactCompilerTaskBClosureProof(files, semanticSources)',
        ],
      },
      {
  ...
  },
  {
    ...
    verdictAnchors: [
      ...
      },
      {
        ...
        snippets: [
          'scopes stock route, list, and direct Button JSX to their actual form owner',
          'accepts exact direct Button JSX import identity through %s',
          'local Button lookalike nested in the form',
          'local alias of a direct Button import nested in the form',
          'namespace Button import nested in the form',
          'barrel Button import nested in the form',
          'type-only Button import nested in the form',
          'shadowed direct Button import nested in the form',
          'reassigned direct Button import nested in the form',
          'mutated direct Button import carrier nested in the form',
          'keeps a direct Button JSX spread closed',
          'keeps direct Button JSX %s closed',
          'opaque expression nested in the form',
          'keeps an unresolved explicit form-association carrier closed outside the form',
          'does not materialize a component project for a non-visual authority module',
          'parses one exact extra-source AST per needed project and reuses that project',
          'invalidates a cached project when the same extra-files array receives new bytes',
          'keeps extra-to-root component imports closed under the extras-only lookup topology',
          'keeps extra-module component alias cycles closed after shared-AST parsing',
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    testFiles: [
      ...
      'packages/cli/src/dependency-capability-loader.scalability.test.ts',
      ...
      'packages/server/src/escape-census-review.security.test.ts',
      'packages/cli/src/commands/build-export.escape-census-reviews.test.ts',
      'packages/cli/src/commands/attest.test.ts',
      'scripts/metric-e-rounds-gate.test.mjs',
    ],
    verdictAnchors: [
      {
        id: 'metric-e-review-subject-emission',
        file: 'packages/cli/src/commands/build-export.escape-census-reviews.test.ts',
        snippets: [
          '@kovo-security-certifies C13 metric-e-review-subject-emission',
          'emits one artifact-bound subject per counted root and binds every collapsed producer site',
          ...
          'lacks a closed counted-root disposition',
        ],
      },
      {
        id: 'metric-e-attestation-composition',
        file: 'packages/cli/src/commands/attest.test.ts',
        snippets: [
          '@kovo-security-certifies C13 metric-e-attestation-composition',
          'verifies the caller nonce, artifact subject, posture digest, Ed25519 key, and signature',
          'ESCAPE-CENSUS-REVIEWS verified=1',
          'pinned key holder approved the exact subject bytes',
          'does not prove an obligation true or identify an independent human',
        ],
      },
      {
        id: 'metric-e-escape-review-signature',
        file: 'packages/server/src/escape-census-review.security.test.ts',
        snippets: [
          '@kovo-security-certifies C13 metric-e-escape-review-signature',
          'binds the exact door, root, complete producer-site set, artifact, and existing anchor',
          'rejects replacement keys, malformed fields, accessors, and unsupported doors',
          'keeps the signer off build and execution surfaces',
          'requires an exact one-to-one set before returning reviewed Metric E roots',
          'duplicate root identity',
          'bounds each exact producer-site set before indexing review evidence',
        ],
      },
      {
        id: 'metric-e-round-signature-join',
        file: 'scripts/metric-e-rounds-gate.test.mjs',
        snippets: [
          '@kovo-security-certifies C13 metric-e-round-signature-join',
          'qualifies an exact detached Ed25519 set only under the external runtime anchor',
          'rejects coherently rewritten and re-signed repository evidence under a replacement key',
          'rejects forged, missing, surplus, stale-subject, and wrong-anchor review sets',
          ...
          'qualifies three externally authenticated reviews over real distinct chained commits',
          'rejects a 64-byte RSA-512 signature instead of labeling it Ed25519 evidence',
      ...
      },
      {
        ...
        snippets: [
          ...
          'rejects a 64-byte RSA-512 signature instead of labeling it Ed25519',
      ...
      {
        id: 'dependency-configured-alias-identity-join',
        file: 'packages/cli/src/dependency-capability-loader.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-configured-alias-identity-join',
          'enforces the manifest in a real Vite import path before admitting app dependencies',
          "resolve: { alias: { 'safe-parser': join(packageRoot, 'index.js') } }",
          'authored an unadmitted edge',
          'alias resolves outside its exact package export target',
        ],
      },
      {
        id: 'dependency-browser-carrier-recursion-budget',
        file: 'packages/cli/src/dependency-capability-loader.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-carrier-recursion-budget',
          'recursiveCallableCarrierExpression',
      ...
      {
        id: 'dependency-browser-carrier-finite-budget',
        file: 'packages/cli/src/dependency-capability-loader.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-carrier-finite-budget',
          'finiteBrowserBudgetExhaustionExpression',
      ...
      {
        id: 'dependency-browser-opacity-finite-summary',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          ...
          'wideMemberCount = 1_600',
          'repeatedStructuredTransfers',
          'classifier-scale-ok',
        ],
      },
      {
        id: 'dependency-browser-opacity-stable-provenance-batch',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-stable-provenance-batch',
          'admits a repeated wide safe closure across unrelated assignment provenance',
          'provenanceChurnedStructuredTransfers',
          'classifier-churn-ok',
          'target.p63',
        ],
      },
      {
        id: 'dependency-browser-opacity-stable-binding-memo',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-stable-binding-memo',
          'admits a repeated safe closure through one stable binding',
          'repeatedAliasTransferCount = 7_500',
          'repeatedAliasTransfers',
          'binding-memo-ok',
        ],
      },
      {
        id: 'dependency-browser-opacity-late-member-alias',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-late-member-alias',
          'closes a member write whose receiver is resolved by a later alias source',
          'function install() { alias.platform = poison; }',
          'alias = box',
          "new box.platform.Worker('/payload.mjs')",
        ],
      },
      {
        id: 'dependency-browser-opacity-mode-separation',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-mode-separation',
          'distinguishes a value-only callable summary from whole-closure inspection',
      ...
      {
        id: 'dependency-browser-opacity-inline-closure-capture',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-inline-closure-capture',
          'closes a captured object transferred through an inline closure',
          'unknownSink(() => box)',
          "new box.platform.Worker('/payload.mjs')",
          'opaque browser executable carrier',
        ],
      ...
      {
        id: 'dependency-browser-opacity-nested-return-capture',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-nested-return-capture',
          'closes captures behind a local callable returned into an opaque container',
      ...
      {
        id: 'dependency-browser-opacity-direct-call-cache-invalidation',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-direct-call-cache-invalidation',
          'invalidates a direct local-callee summary after prototype replacement',
          'unknownSink([local({})])',
          'local.__proto__ = {}',
          "new box.platform.Worker('/payload.mjs')",
        ],
      ...
      {
        id: 'dependency-browser-opacity-first-call-opaque-constructor',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-first-call-opaque-constructor',
          'closes a first direct local call after prototype replacement',
          'local.__proto__ = {}',
      ...
      {
        id: 'dependency-browser-opacity-returned-function-self',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-returned-function-self',
          'closes a named local function returned through its self binding',
          'const local = function self() { return self; }',
          'unknownSink([local()])',
          "new local.platform.Worker('/payload.mjs')",
        ],
      },
      {
        id: 'dependency-browser-opacity-module-meta',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-module-meta',
          'closes mutable import.meta after an opaque structured transfer',
          'unknownSink(import.meta)',
          'module-meta-transfer-closed',
          'opaque browser executable carrier',
        ],
      },
      {
        id: 'dependency-browser-opacity-module-meta-return',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-module-meta-return',
          'closes import.meta returned through a summarized local callable',
          'function expose() { return import.meta; }',
          'unknownSink([expose()])',
          'module-meta-return-closed',
        ],
      },
      {
        id: 'dependency-browser-opacity-module-meta-member-alias',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-module-meta-member-alias',
          'closes an aliased mutable member of import.meta',
          'import.meta.shared = {}',
      ...
      {
        id: 'dependency-browser-opacity-unresolved-global',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-unresolved-global',
          'closes an unresolved global after an opaque structured transfer',
          'unknownSink(externalGlobal)',
          "new externalGlobal.platform.Worker('/payload.mjs')",
          'opaque browser executable carrier',
        ],
      },
      {
        id: 'dependency-browser-opacity-unresolved-global-member',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-unresolved-global-member',
          'retains unresolved-global origin through an opaque member transfer',
          'unknownSink(externalGlobal.shared)',
          "new externalGlobal.shared.platform.Worker('/payload.mjs')",
          'opaque browser executable carrier',
        ],
      },
      {
        id: 'dependency-browser-opacity-unresolved-global-return',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-unresolved-global-return',
          'closes an unresolved global returned through a summarized local callable',
          'function expose() { return externalGlobal; }',
          'unknownSink([expose()])',
          "new externalGlobal.platform.Worker('/payload.mjs')",
        ],
      },
      {
        id: 'dependency-browser-opacity-syntax-key-not-global',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-syntax-key-not-global',
          'does not treat a class method key as an unresolved global capture',
          'const Local = class { constructor() {} }',
          'unknownSink(Local)',
          'new Map().size',
        ],
      },
      {
        id: 'dependency-browser-opacity-poison-first',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-poison-first',
          'keeps a poison transferred before repeated safe closures closed',
          'Reflect.construct(URL',
          'selected = wideSafe',
          'opaque browser executable carrier',
        ],
      },
      {
        id: 'dependency-browser-opacity-poison-late',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-poison-late',
          'replays a shared structured value after a late graph poison',
          'selected = box',
          "new box.platform.Worker('/payload.mjs')",
        ],
      },
      {
        id: 'dependency-browser-opacity-shadowed-authority',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-shadowed-authority',
          'keeps memoized closure inspection lexical when ambient authority names are shadowed',
          'const Reflect = { construct',
          'class URL {}',
          'shadowed-scale-ok',
        ],
      },
      {
        id: 'dependency-retained-browser-carrier-closure',
        file: 'packages/cli/src/dependency-capability-loader.test.ts',
        snippets: [
          ...
          'LocalAssetReference',
          'SafeURLAlias',
          'opaque new-URL executable asset',
        ],
      },
      {
        id: 'dependency-real-drizzle-noncarrier',
        file: 'packages/cli/src/dependency-capability-loader.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-real-drizzle-noncarrier',
          'admits the retained real Drizzle eq graph as a proved browser non-carrier',
      ...
      {
        id: 'dependency-closed-constructor-chain',
        file: 'packages/cli/src/dependency-capability-loader.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-closed-constructor-chain',
          'closedBrowserValueDynamicWorkerExpression',
          'globalThis.location.constructor.constructor',
          'closed-browser-value constructor-chain dynamic Worker',
          'opaque browser executable carrier executable asset',
        ],
      },
      {
        id: 'dependency-invocation-adapter-closure',
        file: 'packages/cli/src/dependency-capability-loader.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-invocation-adapter-closure',
          'dynamicCodeAdapterCarrierExpressions',
          'timerAdapterCarrierExpressions',
          'descriptor Reflect.construct Worker',
          'admits direct timers with proved callbacks and local carrier-shaped properties',
        ],
      },
      {
        id: 'dependency-browser-carrier-client-lane',
        file: 'packages/cli/src/dependency-capability-loader.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-carrier-client-lane',
          'limits browser carrier evaluation to client artifacts',
          "await expect(build('build-server')).resolves.toBeDefined()",
          "await expect(build('build-client')).rejects.toThrow",
          'supported build-client artifact',
        ],
      },
      {
      ...
      {
        id: 'dependency-browser-css-collector-boundary',
        file: 'packages/compiler/src/vite.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-css-collector-boundary',
          'collects component CSS through an inert browser module boundary',
          'Compiler-owned CSS collection boundary',
          'CssOnlyBoundary$button_click',
          "isFrameworkKovoVitePluginOwnerForSourceRoot(plugin, 'src')",
        ],
      },
      {
        id: 'dependency-browser-opacity-owned-chunk-import',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-owned-chunk-import',
          'closes a mutable binding retained across owned client chunks',
          'unknownSink(shared)',
          "new shared.platform.Worker('/payload.mjs')",
        ],
      },
      {
        id: 'dependency-browser-opacity-owned-chunk-import-variants',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
      ...
      {
        id: 'dependency-browser-opacity-owned-chunk-call-result',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-owned-chunk-call-result',
          'closes an opaque imported-call result that can alias another live chunk export',
          'unknownSink(expose())',
          'export function expose() { return shared; }',
        ],
      },
      {
        id: 'dependency-browser-opacity-owned-chunk-constructor-result',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-owned-chunk-constructor-result',
          'closes an opaque imported-constructor result that can alias another export',
          'unknownSink(new Expose())',
          'export class Expose { constructor() { return shared; } }',
        ],
      },
      {
        id: 'dependency-browser-opacity-owned-chunk-positive-control',
        file: 'packages/cli/src/dependency-capability-loader.scalability.test.ts',
        snippets: [
          '@kovo-security-certifies C13 dependency-browser-opacity-owned-chunk-positive-control',
          'retains plain compatibility for an unexposed owned-chunk binding',
          "this.kind = 'owned-chunk-local'",
      ...
      },
      {
        ...
        snippets: [
          ...
          "['cjk.tsx', '中Child']",
          'keeps opaque JSX component invocations beyond the scaled effect-site budget globally fail closed',
          '<Opaque${index} />',
          'keeps genuine opaque effects beyond the scaled effect-site budget globally fail closed',
          'fails closed when the effect-site history exceeds the scaled budget below the ceiling',
          'value.member${index};',
    ...
    verdictAnchors: [
      ...
      },
      {
        ...
        snippets: [
          ...
          'reports KV235 for app-authored key-first registry identities',
          'const runtimeMutationKey',
          'defineMutation(runtimeMutationKey',
          'defineQuery(runtimeQueryKey',
          'App source hard-codes a mutation registry identity',
        ],
      },
      {
      ...
      },
      {
        ...
        file: 'packages/compiler/src/security-operation-ir.security.test.ts',
        snippets: [
          'complete-mutation-form-security-fields recognizes only the exact public security surface',
          ...
          'function mintCsrfField(_context, _options)',
        ],
      },
    ],
  },
    ...
    verdictAnchors: [
      ...
      },
      {
        ...
        snippets: [
          ...
          "'http://app.example/_m/a/%2F/b'",
          "'https://app.example/assets%2fcart.css'",
