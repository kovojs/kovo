    ...
    verdictAnchors: [
      ...
      },
      {
        ...
        snippets: [
          ...
          'records an exact detached Ed25519 set without treating its caller-supplied anchor as independent review',
          'rejects forged, missing, surplus, stale-subject, and wrong-anchor review sets',
          'rejects an independent review that does not bind the signed root set and anchor',
