...
export const SECURITY_BUILD_PROOFS = [
  ...
  },
  {
    ...
    requiredNeedles: [
      ...
      'KV449',
      'secret-view-egress-query',
      'managed database builder continuation',
    ],
  ...
  },
  {
    ...
    requiredNeedles: [
      ...
      'buildParanoidProductionArtifact(root)',
      'KV448',
      'raw crypto-acquisition authority',
      'global crypto',
    ],
    requiredProofFileNeedles: ["KOVO_PARANOID: '1'"],
  ...
  {
    buildInvocation: 'starter-build-production-artifact',
    claimId: 'production-import-equals-capability-closure',
    code: 'KV448',
    proofFile: 'packages/create-kovo/src/index.build.prod-artifact.security.test.ts',
    requiredNeedles: [
    ...
    sourceFile: 'packages/create-kovo/src/index.build.prod-artifact.security.test.ts',
    testName: 'blocks runtime TypeScript import-equals authority in production preflight',
  },
  {
    buildInvocation: 'starter-build-production-artifact',
    claimId: 'production-import-equals-namespace-reexport-closure',
    code: 'KV448',
    proofFile: 'packages/create-kovo/src/index.build.prod-artifact.security.test.ts',
    requiredNeedles: [
  ...
  {
    buildInvocation: 'starter-build-production-artifact',
    claimId: 'production-lexical-binding-provenance-closure',
    code: 'KV448',
    proofFile: 'packages/create-kovo/src/index.build.prod-artifact.security.test.ts',
    requiredNeedles: [
    ...
    sourceFile: 'packages/create-kovo/src/index.build.prod-artifact.security.test.ts',
    testName: 'blocks authority when lexical shadows and mutable aliases obscure route factories',
  },
  {
    buildInvocation: 'starter-build-production-artifact',
