...
const STARTER_ENTRIES = [
  ...
  {
    id: 'transaction-default-artifact',
    file: 'packages/create-kovo/src/index.build.prod-artifact.transactions.test.ts',
    testName: 'rolls back default mutation transactions',
    seconds: 289,
  },
  {
    id: 'transaction-sqlite-readonly-artifact',
    file: 'packages/create-kovo/src/index.build.prod-artifact.transactions.test.ts',
    testName: 'SQLite public GET readonly handles',
    seconds: 288,
  },
  {
