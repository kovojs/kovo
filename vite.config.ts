...
export default defineConfig({
  ...
  fmt: {
    ignorePatterns: [
      ...
      'coverage/**',
      'node_modules/**',
      // Generated byte-stable proof input; formatting it would invalidate its digest.
    ...
    tasks: {
      ...
      'typecheck-examples': {
        ...
        input: [
          ...
          { pattern: 'examples/commerce/src/**/*.tsx', base: 'workspace' },
          ...
          { pattern: 'examples/stackoverflow/src/**/*.tsx', base: 'workspace' },
          ...
          { pattern: 'examples/crm/src/**/*.tsx', base: 'workspace' },
  ...
  pack: {
    entry: [
      ...
      'packages/core/src/storage-public.ts',
      ...
      'packages/core/src/internal/security.ts',
      ...
      'packages/drizzle/src/runtime-metadata-internal.ts',
      ...
      'packages/server/src/internal/fixture-app.ts',
