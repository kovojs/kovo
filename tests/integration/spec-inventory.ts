...
const REQUIRED_RULES: readonly InventoryRule[] = [
  ...
  },
  {
    axis: 'security',
    match:
      /^(auth|bootstrap|csrf|required|endpoint|forbidden|guarded|meta-refresh|query-read-guard|session|storage|webhook|xss|sanitized|unscoped|mutation-targets-malicious)/,
