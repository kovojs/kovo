...
describe('Drizzle pinned subset conformance', () => {
  it('pins real Drizzle materialized-view refresh as an explicit KV406 write surface', () => {
  ...
  it('pins real Drizzle count helper as an explicit KV406 surface', () => {
    const graph = extractTouchGraphFromProject({
      files: [
        {
  ...
  it('pins unknown real Drizzle receiver methods as explicit KV406 surfaces', () => {
    const graph = extractTouchGraphFromProject({
      files: [
        {
          fileName: 'conformance/drizzle-pin/src/users.domain.ts',
  ...
  it('pins computed real Drizzle receiver methods as explicit KV406 surfaces', () => {
    const graph = extractTouchGraphFromProject({
      files: [
        {
          fileName: 'conformance/drizzle-pin/src/users.domain.ts',
  ...
  it('pins bound real Drizzle receiver methods as explicit KV406 surfaces', () => {
    const graph = extractTouchGraphFromProject({
      files: [
        {
          fileName: 'conformance/drizzle-pin/src/users.domain.ts',
  ...
  it('pins assigned real Drizzle receiver methods as explicit KV406 surfaces', () => {
    const graph = extractTouchGraphFromProject({
      files: [
        {
          fileName: 'conformance/drizzle-pin/src/users.domain.ts',
  ...
  it('pins array-destructured real Drizzle receiver methods as explicit KV406 surfaces', () => {
    const graph = extractTouchGraphFromProject({
      files: [
        {
          fileName: 'conformance/drizzle-pin/src/users.domain.ts',
  ...
  it('pins direct real Drizzle carrier member calls as exact facts with KV406 raw calls', () => {
    const graph = extractTouchGraphFromProject({
      files: [
        {
          fileName: 'conformance/drizzle-pin/src/users.domain.ts',
  ...
  it('pins typed real Drizzle query/domain factories as KV406 when callbacks are invisible', () => {
    const files = [
      {
        fileName: 'conformance/drizzle-pin/src/users.domain.ts',
        source: [
          ...
          '',
          "export const userQuery = query('user/factory-loader', { access: publicAccess('drizzle conformance query fixture has no runtime guard'), ...makeQueryOptions() });",
        ].join('\n'),
      },
    ];
    ...
    const files = [
      {
        ...
        source: [
          ...
          "  return { access: publicAccess('drizzle conformance query fixture has no runtime guard'), load: loadUsers };",
          '}',
          '',
          'const makeActions = () => ({',
          '  add: write(addUser),',
          ...
          'export const userDomain = domain(makeActions());',
          '',
          "export const userQuery = query('user/factory-return-loader', { access: publicAccess('drizzle conformance query fixture has no runtime guard'), ...makeOptions() });",
        ].join('\n'),
      },
    ];
    ...
    const files = [
      {
        ...
        source: [
          ...
          '',
          'function makeOptions() {',
          "  const base = { access: publicAccess('drizzle conformance query fixture has no runtime guard'), load: loadUsers };",
          '  const options = { ...base };',
          '  return options;',
          '}',
          '',
          ...
          'export const userDomain = domain(makeActions());',
          '',
          "export const userQuery = query('user/local-factory-return-loader', { access: publicAccess('drizzle conformance query fixture has no runtime guard'), ...makeOptions() });",
        ].join('\n'),
      },
    ];
