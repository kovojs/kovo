  ...
  return (
    <main>
      <section className="hero">
        ...
        <p>A 24-product commerce benchmark rendered with TanStack Start SSR and hydrated cart UI.</p>
      </section>
        ...
        {products.map((product) => (
          <article className="card" key={product.id}>
            ...
            <div className="card-actions">
              <Link className="secondary-button" to="/product/$slug" params={{ slug: product.slug }}>
                Details
              </Link>
