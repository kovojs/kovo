...
| KV435 | error    | Secret-classified query result field, or an opaque/unresolved projection from a table carrying secret columns, reaches the client query wire; remove the field/opaque projection or use an audited reveal/redaction surface (§6.2, §10.2, §11.3)                                                                                                                                                                                                                  |
