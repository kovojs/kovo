...
| KV435 | error    | Secret-classified query result field reaches the client query wire; remove the field from the projection or use an audited reveal/redaction surface (§6.2, §10.2)                                                                                                                                                                                                                                                                                                 |
