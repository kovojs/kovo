...
- Targeted regression app `/Users/mini/kovo-dogfood-regression-20260630-2003`: `pnpm run check`, `pnpm run test`, `pnpm run build:prod`, and a production no-JS POST to `/dogfood-regression-proof` passed for A1/B1/C1 surfaces; root `pnpm install` repair and style transitive-dep resolve passed afterward.
