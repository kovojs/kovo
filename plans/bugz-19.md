...
- [ ] **B1 — State-dependent conditional text in client islands is silently stale when the same element has reactive attribute derives.** (high, framework soundness; found by `t1-interaction-ladder`, verified independently)
