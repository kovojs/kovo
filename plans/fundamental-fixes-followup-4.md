...
- Current integrated gates: `pnpm run check`, `pnpm exec vitest --run packages/create-kovo/src/index.build.prod-artifact.security.test.ts --reporter=dot` (12 tests), `pnpm exec vitest --run scripts/security-test-build-gate.test.mjs scripts/security-gate-mutations.test.mjs scripts/check-single-choke.test.mjs --reporter=dot` (37 tests), and `git diff --check`.
