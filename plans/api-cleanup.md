...
**Status:** open (9 / 25 slices closed — Phases 1–2 done; Phase 3 enforcement+stability done (dist-exports flip carved out); Phase 4 compiler+CLI done, headless-ui subpaths fenced (primitive docs = ratchet debt). api-surface baseline 3957→3782.)
