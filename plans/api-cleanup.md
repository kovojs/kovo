...
**Status:** open (13 / 25 slices closed — Phases 1, 2, 4, 6 done; Phase 3 enforcement+stability done (dist-exports flip carved out, task #9); headless-ui primitive docs = ratchet debt. Remaining: Phase 5 (core/server/runtime barrel carve + test→conformance-fixtures split), Phase 7 (ui copy-in), Phase 8 (api-ref expansion + STABILITY page), and the documentation long-tail. **api-surface baseline 3957→3683** and ratcheting down.)
