...
- [ ] **Phase 1: lock down the responsibility map before refactoring.**
  ...
  - Evidence needed: checked-in table in this plan or a linked doc plus focused
    tests named for any responsibility that is intentionally inline-only.
