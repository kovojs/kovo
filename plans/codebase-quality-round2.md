...
- `pnpm run check` passed after the latest integrated app-shell/UI/Drizzle/runtime/harness wave:
  764 formatted files, 666 lint/typechecked files, and 7 typechecked example/conformance projects.
