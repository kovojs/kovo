...
- **census-completeness durable-task-path exploitability:** refuted — the specific path is framework-safe; only the *completeness-gate soundness* (P1) is the defect.
