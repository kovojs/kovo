...
under-boxes (`bugz-29` B1) also over-boxes legit reads. The re-architecture's _principle_ is right; its _acceptance
and TCB accounting_ are the enumerate-and-allow failure, now in the proof machinery itself.
