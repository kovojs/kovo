...
/** Wifi Cog icon (Lucide). https://lucide.dev/icons/wifi-cog */
export function WifiCog(props: IconProps = {}): ComponentRenderResult {
  return (
    <svg {...iconRootAttrs(props)}>
      ...
      <path d="M2 7.82a15 15 0 0 1 20 0"></path>
      <path d="m20.772 16.852.924-.383"></path>
      <path d="m20.772 19.148.924.383"></path>
      <path d="M5 11.858a10 10 0 0 1 11.5-1.785"></path>
      <path d="M8.5 15.429a5 5 0 0 1 2.413-1.31"></path>
