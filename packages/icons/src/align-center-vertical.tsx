...
/** Align Center Vertical icon (Lucide). https://lucide.dev/icons/align-center-vertical */
export function AlignCenterVertical(props: IconProps = {}): ComponentRenderResult {
  return (
