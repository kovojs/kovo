...
/** Receipt Russian Ruble icon (Lucide). https://lucide.dev/icons/receipt-russian-ruble */
export function ReceiptRussianRuble(props: IconProps = {}): ComponentRenderResult {
  return (
