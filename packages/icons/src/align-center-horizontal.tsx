...
/** Align Center Horizontal icon (Lucide). https://lucide.dev/icons/align-center-horizontal */
export function AlignCenterHorizontal(props: IconProps = {}): ComponentRenderResult {
  return (
