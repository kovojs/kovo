...
/** Briefcase Conveyor Belt icon (Lucide). https://lucide.dev/icons/briefcase-conveyor-belt */
export function BriefcaseConveyorBelt(props: IconProps = {}): ComponentRenderResult {
  return (
