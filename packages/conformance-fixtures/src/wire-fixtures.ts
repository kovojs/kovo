...
<script data-kovo-csp-hash="sha256-ypUXuMXJfQBi+znI/iM0i9hymU6htM6+FxKC3cEA7BQ=">var s=document.currentScript,n=s.previousSibling,e=[],v=[];for(;n;){var p=n.previousSibling,t=n.textContent||"";if(n.outerHTML){e.unshift(n.outerHTML);if(n.localName==="kovo-fragment"&&n.getAttribute("priority")==="visible")v.unshift(n.getAttribute("target"))}n.remove();if(t.includes("--kovo-boundary"))break;n=p}var b=e.join("\\n"),a=()=>globalThis.__kovo_a?.(b),o=globalThis.IntersectionObserver&&new IntersectionObserver((r)=>{for(const x of r)if(x.isIntersecting){o.disconnect();a();break}},{rootMargin:"600px 0px"}),c=0;if(o){for(var w of v){var d=w!==null&&[...document.getElementsByTagName("kovo-defer")].find((x)=>x.getAttribute("target")===w);if(d){o.observe(d);c++}}}if(!c)a();s.remove()</script>
--kovo-boundary--
<script data-kovo-csp-hash="sha256-RQiNXtumxHylKW0DJGBYQZiSYMMim4HSCB8EkPlTgvA=">for(var n of [...document.body.childNodes])if((n.textContent||"").includes("--kovo-boundary"))n.remove();document.currentScript.remove()</script>
</body></html>
`,
  ],
