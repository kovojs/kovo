...
<script data-kovo-csp-hash="sha256-WhEtASH76iI+YbSE0Y/G4JUim41Bh2qPB3RiL5F5HUo=">var s=document.currentScript,n=s.previousSibling,e=[];for(;n;){var p=n.previousSibling,t=n.textContent||"";if(n.outerHTML)e.unshift(n.outerHTML);n.remove();if(t.includes("--kovo-boundary"))break;n=p}globalThis.__kovo_a?.(e.join("\\n"));s.remove()</script>
--kovo-boundary--
