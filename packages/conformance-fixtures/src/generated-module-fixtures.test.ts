...
`,
  ...
  it('summarizes generated handler hrefs as reusable artifact facts', () => {
    expect(
      generatedHandlerReferenceFact(
        '/c/__v/0a1b2c3d0a1b2c3d0a1b2c3d0a1b2c3d0a1b2c3d0a1b2c3d0a1b2c3d0a1b2c3d/routes/products/product-card.client.js#ProductCard$button_click',
      ),
    ).toEqual({
      handlerName: 'ProductCard$button_click',
      modulePath: '/c/routes/products/product-card.client.js',
      requestPath:
        '/c/__v/0a1b2c3d0a1b2c3d0a1b2c3d0a1b2c3d0a1b2c3d0a1b2c3d0a1b2c3d0a1b2c3d/routes/products/product-card.client.js',
      staleVersionRequestPath: `/c/__v/${'0'.repeat(64)}/routes/products/product-card.client.js`,
      version: '0a1b2c3d0a1b2c3d0a1b2c3d0a1b2c3d0a1b2c3d0a1b2c3d0a1b2c3d0a1b2c3d',
