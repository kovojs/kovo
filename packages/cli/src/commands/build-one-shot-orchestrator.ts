...
// A one-shot analysis can itself run the bounded 300s static-trust worker. The outer phase gets
// three times that measured ceiling so loaded CI remains viable, while every spawn/input/work/
