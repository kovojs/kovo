...
describe('kovo add', () => {
  ...
  it('vendors package-synchronized components as TSX app source', async () => {
    ...
    try {
      ...
      expect(accordion).toContain('const accordionStyles = style.create');
      ...
      expect(autocomplete).toContain('const autocompleteStyles = style.create');
      ...
      expect(breadcrumb).toContain('const breadcrumbStyles = style.create');
      ...
      expect(checkbox).toContain('const checkboxStyles = style.create');
      ...
      expect(checkboxGroup).toContain('const checkboxGroupStyles = style.create');
      ...
      expect(combobox).toContain('const comboboxStyles = style.create');
      ...
      expect(command).toContain('const commandStyles = style.create');
      ...
      expect(contextMenu).toContain('const contextMenuStyles = style.create');
      ...
      expect(dropdownMenu).toContain('const dropdownMenuStyles = style.create');
      ...
      expect(kbd).toContain('const kbdStyles = style.create');
      ...
      expect(menubar).toContain('const menubarStyles = style.create');
      ...
      expect(meter).toContain('const meterStyles = style.create');
      ...
      expect(navigationMenu).toContain('const navigationMenuStyles = style.create');
      ...
      expect(progress).toContain('const progressStyles = style.create');
      ...
      expect(radioGroup).toContain('const radioGroupStyles = style.create');
      ...
      expect(select).toContain('const selectStyles = style.create');
      ...
      expect(scrollArea).toContain('const scrollAreaStyles = style.create');
      ...
      expect(sheet).toContain('const sheetStyles = style.create');
      ...
      expect(skeleton).toContain('const skeletonStyles = style.create');
      ...
      expect(slider).toContain('const sliderStyles = style.create');
      ...
      expect(switchSource).toContain('const switchStyles = style.create');
      ...
      expect(table).toContain('const tableStyles = style.create');
      expect(table).toContain('styles?: TableStyleOverrides');
      expect(table).toContain('const rowChildren = children;');
      expect(tabs).toContain("import * as style from '@kovojs/style';");
      expect(tabs).toContain('const tabsStyles = style.create');
      ...
      expect(toggleGroup).toContain('const toggleGroupStyles = style.create');
      ...
      expect(toast).toContain('const toastStyles = style.create');
      ...
      expect(toolbar).toContain('const toolbarStyles = style.create');
      ...
      expect(vendoredSource).not.toMatch(/\bexport const [A-Za-z]+Styles\b/);
