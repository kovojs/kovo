...
export const EXPLAIN_USAGE = [
  'usage: kovo explain component|mutation|query|page <target> [--optimistic] [graph.json]',
...
export const EXPLAIN_USAGE_LINE =
  'kovo explain component|mutation|query|page <target> [--optimistic] [graph.json] | kovo explain --endpoints [graph.json] | kovo explain --unguarded [--fail-on-findings] [graph.json] | kovo explain --unscoped [--fail-on-findings] [graph.json]';
