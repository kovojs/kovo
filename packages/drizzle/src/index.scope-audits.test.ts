        ...
        files: [
          ...
          ]),
          {
            ...
            source: [
              ...
              '',
              'export const orders = pgTable("orders", { id: text("id").primaryKey(), userId: text("user_id").notNull() }, kovo((columns) => ({ domain: "order", key: (t) => t.id, owner: (t) => t.userId })));',
              '',
        ...
        files: [
          pgDatabaseTypes(WRITE_DB_METHODS),
          {
            ...
            source: [
              ...
              '',
              'export const projects = pgTable("projects", { id: text("id").primaryKey(), ownerId: text("owner_id").notNull(), name: text("name").notNull() }, kovo((columns) => ({ domain: "project", key: (t) => t.id, owner: (t) => t.ownerId })));',
              'export const tasks = pgTable("tasks", { id: text("id").primaryKey(), ownerId: text("owner_id").notNull(), status: text("status").notNull() }, kovo((columns) => ({ domain: "task", key: (t) => t.id, owner: (t) => t.ownerId })));',
              '',
        ...
        files: [
          pgDatabaseTypes(WRITE_DB_METHODS),
          {
            ...
            source: [
              ...
              'import type { PgAsyncDatabase } from "drizzle-orm/pg-core";',
              '',
              'export const projects = pgTable("projects", { id: text("id").primaryKey(), ownerId: text("owner_id").notNull(), budgetCents: integer("budget_cents").notNull() }, kovo((columns) => ({ domain: "project", key: "id", owner: "ownerId" })));',
              '',
        ...
        files: [
          pgDatabaseTypes(WRITE_DB_METHODS),
          {
            ...
            source: [
              ...
              'export const widgets = pgTable("widgets", { id: text("id").primaryKey(), ownerId: text("owner_id").notNull() }, kovo((columns) => ({ domain: "widget", key: (t) => t.id, owner: (t) => t.ownerId })));',
              '',
        ...
        files: [
          pgDatabaseTypes(WRITE_DB_METHODS),
          {
            ...
            source: [
              ...
              'import { mutation, s } from "@kovojs/server";',
              '',
              'export const orders = pgTable("orders", { id: text("id").primaryKey(), userId: text("user_id").notNull(), status: text("status").notNull() }, kovo((columns) => ({ domain: "order", key: (t) => t.id, owner: (t) => t.userId })));',
              '',
        ...
        files: [
          ...
          ]),
          {
            ...
            source: [
              ...
              '',
              'export const orders = pgTable("orders", { id: text("id").primaryKey(), userId: text("user_id").notNull(), status: text("status").notNull() }, kovo((columns) => ({ domain: "order", key: (t) => t.id, owner: (t) => t.userId })));',
              'export const items = pgTable("items", { id: text("id").primaryKey(), orderId: text("order_id").notNull() }, kovo((columns) => ({ domain: "item", key: (t) => t.id })));',
              '',
        ...
        files: [
          ...
          ]),
          {
            ...
            source: [
              ...
              'import type { PgAsyncDatabase } from "drizzle-orm/pg-core";',
              '',
              'export const orders = pgTable("orders", { id: text("id").primaryKey(), alternateId: text("alternate_id").notNull(), userId: text("user_id").notNull() }, kovo((columns) => ({ domain: "order", key: (t) => t.id, owner: (t) => t.userId })));',
              '',
              'export const orderById = query("orderById", {',
              '  output: s.object({ id: s.string() }),',
              '  async load(input: { id: string }, db: PgAsyncDatabase<any, any>) {',
        ...
        files: [
          ...
          ]),
          {
            ...
            source: [
              ...
              'import { query, s } from "@kovojs/server";',
              '',
              'export const orders = pgTable("orders", { id: text("id").primaryKey(), "profile.userId": text("profile_user_id").notNull() }, kovo((columns) => ({ domain: "order", key: (t) => t.id, owner: "profile.userId" })));',
              '',
