    ...
    const files = [
      pgDatabaseTypes(['select(value?: unknown): { from(table: unknown): Promise<unknown[]> };']),
      {
        ...
        source: [
          ...
          '}, kovo((columns) => ({ domain: "question", key: "id" })));',
          '',
    ...
    const files = [
      ...
      ]),
      {
        ...
        source: [
          ...
          '}, kovo((columns) => ({ domain: "ticket", key: "tenantId,id" })));',
          '',
    ...
    const files = [
      ...
      ]),
      {
        ...
        source: [
          ...
          '  id: text("id").notNull(),',
          '  status: text("status").notNull(),',
          '}, kovo((columns) => ({ domain: "document", key: "guardId,id" })));',
          '',
    ...
    const files = [
      ...
      ]),
      {
        ...
        source: [
          ...
          '  status: text("status").notNull(),',
          '}, kovo((columns) => ({ domain: "case-file", key: "userId,id", owner: "userId" })));',
          '',
    ...
    const files = [
      ...
      ]),
      {
        ...
        source: [
          ...
          '  status: text("status").notNull(),',
          '  title: text("title").notNull(),',
          '}, kovo((columns) => ({ domain: "case", key: "userId,id", owner: "userId" })));',
          '',
    ...
    const files = [
      ...
      ]),
      {
        ...
        source: [
          ...
          '}, kovo((columns) => ({ domain: "cart-item", key: "cartId,productId" })));',
          '',
    ...
    const files = [
      ...
      ]),
      {
        ...
        source: [
          ...
          '  title: text("title").notNull(),',
          '  status: text("status").notNull(),',
          '}, kovo((columns) => ({ domain: "task", key: "id" })));',
          '',
    ...
    const files = [
      ...
      ]),
      {
        ...
        source: [
          ...
          '  id: text("id").notNull(),',
          '  status: text("status").notNull(),',
          '}, kovo((columns) => ({ domain: "invoice", key: "sessionId,id" })));',
          '',
