    ...
    const files = [
      ...
      ]),
      {
        ...
        source: [
          ...
          '',
          'function currentTenantId(context: { tenant: { id: string } }) {',
          ...
          '  async load(_input: {}, db: PgAsyncDatabase<any, any>, context: { tenant: { id: string } }) {',
          ...
          '});',
          '',
          'export async function closeTicket(db: PgAsyncDatabase<any, any>, context: { tenant: { id: string } }, targetId: string) {',
          '  const tenantId = currentTenantId(context);',
    ...
    const files = [
      ...
      ]),
      {
        ...
        source: [
          ...
          '',
          'function currentGuardId(context: { guard: { owner: { id: string } } }) {',
          '  return context.guard.owner.id;',
          '}',
          'kovoAnalyzerSummary(currentGuardId, { returns: { kind: "guard", path: "owner.id" } });',
          '',
          'export const openDocuments = query("openDocuments", {',
          '  async load(_input: {}, db: PgAsyncDatabase<any, any>, context: { guard: { owner: { id: string } } }) {',
          ...
          '});',
          '',
          'export async function archiveDocument(db: PgAsyncDatabase<any, any>, context: { guard: { owner: { id: string } } }, targetId: string) {',
          '  const guardId = currentGuardId(context);',
    ...
    const files = [
      ...
      ]),
      {
        ...
        source: [
          ...
          '',
          'function currentGuardUser(ctx: { guard: { userId: string } }) {',
          ...
          '  async load(_input: {}, db: PgAsyncDatabase<any, any>, ctx: { guard: { userId: string } }) {',
          ...
          '});',
          '',
          'export async function archiveCaseFile(db: PgAsyncDatabase<any, any>, ctx: { guard: { userId: string } }, targetId: string) {',
          '  const userId = currentGuardUser(ctx);',
    ...
    const files = [
      ...
      ]),
      {
        ...
        source: [
          ...
          '',
          'function currentGuardUser(ctx: { guard: { userId: string; actorId: string } }) {',
          '  return ctx.guard.userId;',
          '}',
          ...
          '  async load(_input: {}, db: PgAsyncDatabase<any, any>, ctx: { guard: { userId: string; actorId: string } }) {',
          ...
          '});',
          '',
          'export async function archiveCase(db: PgAsyncDatabase<any, any>, ctx: { guard: { userId: string; actorId: string } }, targetId: string) {',
          '  const ownerId = currentGuardUser(ctx);',
          '  await db.update(cases).set({ status: "archived" }).where(and(eq(cases.userId, ownerId), eq(cases.id, targetId)));',
          '}',
          '',
          'export async function closeCase(db: PgAsyncDatabase<any, any>, ctx: { guard: { userId: string; actorId: string } }, targetId: string) {',
          '  const ownerId = currentGuardUser(ctx);',
    ...
    const files = [
      ...
      ]),
      {
        ...
        source: [
          ...
          '',
          'function currentCartId(context: { request: { session: { cartId: string } } }) {',
          ...
          '  async load(_input: {}, db: PgAsyncDatabase<any, any>, context: { request: { session: { cartId: string } } }) {',
    ...
    const files = [
      ...
      ]),
      {
        ...
        source: [
          ...
          '  async load(_input: {}, db: PgAsyncDatabase<any, any>, context: { request: { session: { id: string } } }) {',
          ...
          '});',
          '',
          'export async function markPaid(db: PgAsyncDatabase<any, any>, context: { request: { session: { id: string } } }, targetId: string) {',
          '  const sessionId = requireSessionId(context);',
