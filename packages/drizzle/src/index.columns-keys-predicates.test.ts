      ...
      files: [
        {
          ...
          source: `
            ...
            }, kovo((columns) => ({ domain: "user", key: columns.id, secret: [columns.totpSecret] })));
      ...
      files: [
        ...
        ]),
        {
          ...
          source: [
            ...
            'import type { PgAsyncDatabase } from "drizzle-orm/pg-core";',
            '',
            'export const users = pgTable("users", {}, kovo((columns) => ({ domain: "user", key: [columns.id, columns.tenantId] })));',
            '',
      ...
      files: [
        ...
        ]),
        {
          ...
          source: [
            ...
            'import type { PgAsyncDatabase } from "drizzle-orm/pg-core";',
            '',
            'export const tickets = pgTable("tickets", {}, kovo((columns) => ({ domain: "ticket", key: [columns.tenantId, columns.id] })));',
            '',
      ...
      files: [
        ...
        ]),
        {
          ...
          source: [
            ...
            '',
            'export const questions = pgTable("questions", {}, kovo((columns) => ({ domain: "question", key: [columns.sessionId, columns.id] })));',
            '',
    ...
    const files = [
      ...
      ]),
      {
        ...
        source: [
          ...
          '',
          'export const questions = pgTable("questions", {}, kovo((columns) => ({ domain: "question", key: [columns.sessionId, columns.id] })));',
          'export const votes = pgTable("votes", {}, kovo((columns) => ({ domain: "vote", key: [columns.sessionId, columns.id] })));',
          '',
          'type AppRequest = { db: PgAsyncDatabase<any, any>; session?: { id?: string } | null };',
          'export const voteUp = mutation("voteUp", {',
