...
export const diagnosticDefinitions = {
  ...
  KV433: {
    code: 'KV433',
    help: [
      'Would lower to: a read-only query() loader handle with no insert/update/delete/execute, and (Stage 2) a static proof that no write is reachable from the loader.',
