...
export const diagnosticDefinitions = {
  ...
  KV434: {
    code: 'KV434',
    help: [
      'Would lower to: a wire string validator backed by a blessed linear matcher (email/url/uuid/slug) or a compile-visible literal pattern with no exponential structure, executed under a runtime step-budget.',
