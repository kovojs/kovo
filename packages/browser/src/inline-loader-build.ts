...
// imagesrcset, comma-aware srcset, CSS text, and raw-HTML sink names; and (4) the §9.3
// `mode="prepend"` wire capability — the `p` closure gained a keyed-dedup insert-at-START branch
// with the scroll-anchor guarantee for "load older" feeds, raising the ceiling 10000 → 10500. The
// TT API tokens and sanitizer grammar remain irreducible; future increases require comparable
// XSS-sink or first-class-wire-capability evidence.
