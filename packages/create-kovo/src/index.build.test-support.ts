...
export function addRuntimeSecretBoundaryProof(root: string): void {
  ...
  app = replaceRequired(
    app,
    "import { contactsQuery } from './queries.js';",
    "import { contactsQuery, runtimeSecretColumnEgressQuery, runtimeSecretComputedEgressQuery, runtimeSecretDeclaredRawEgressQuery, runtimeSecretDeclaredRawRevealQuery, runtimeSecretDefaultRawPublicQuery, runtimeSecretDefaultRawRefusalQuery, runtimeSecretFunctionEgressQuery, runtimeSecretOpaqueRawEgressQuery, runtimeSecretRawEgressQuery, runtimeSecretRevealEgressQuery, runtimeSecretWholeTableEgressQuery } from './queries.js';",
