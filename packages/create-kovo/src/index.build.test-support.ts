...
export function addStorageMutationWriteProof(root: string): void {
  writeFileSync(
    ...
    [
      ...
      '  access: publicProof,',
      '  csrf: false,',
      "  csrfJustification: 'public storage proof uses no session or cookie authority',",
...
export function addStarterMutationDbScopeProof(root: string): void {
  writeFileSync(
    ...
    [
      ...
      '    void input;',
      '    await starterAuthUserTableWrite.run(request.db);',
      '    return { ok: true };',
      '  },',
      '});',
      ...
      '  async handler(input: { marker: string }, request: AppRequest) {',
      '    void input;',
      '    await starterAuthSessionTableWrite.run(request.db);',
      '    return { ok: true };',
      '  },',
      '});',
      ...
      '  async handler(input: { marker: string }, request: AppRequest) {',
      '    void input;',
      '    await starterRawAuthTableWrite.run(request.db);',
      '    return { ok: true };',
      '  },',
      '});',
      ...
      '  async handler(input: { marker: string }, request: AppRequest) {',
      '    void input;',
      '    await starterAbsentTablesContactWrite.run(request.db);',
      '    return { ok: true };',
      '  },',
      '});',
