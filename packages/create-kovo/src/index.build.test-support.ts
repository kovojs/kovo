...
export function addRuntimeSecretBoundaryProof(root: string): void {
  ...
  app = replaceRequired(
    app,
    "import { contactsQuery } from './queries.js';",
    "import { contactsQuery, runtimeSecretColumnEgressQuery, runtimeSecretComputedEgressQuery, runtimeSecretFunctionEgressQuery, runtimeSecretOpaqueRawEgressQuery, runtimeSecretRawEgressQuery, runtimeSecretRevealEgressQuery, runtimeSecretWholeTableEgressQuery } from './queries.js';",
    'runtime secret proof app import',
  );
  app = replaceRequired(
    app,
    '  queries: [contactsQuery],',
    '  queries: [contactsQuery, runtimeSecretColumnEgressQuery, runtimeSecretComputedEgressQuery, runtimeSecretFunctionEgressQuery, runtimeSecretOpaqueRawEgressQuery, runtimeSecretRawEgressQuery, runtimeSecretRevealEgressQuery, runtimeSecretWholeTableEgressQuery],',
