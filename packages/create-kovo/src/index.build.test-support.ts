...
import { webhook${includeWebhookTransactionProof ? ', createMemoryWebhookReplayStore, webhookReplayIdentity' : ''} } from '@kovojs/server/webhooks';`,
      ...
      ...(includeReadonlyMutationAttempt
        ? [
            ...
            '  try {',
            '    const sqlMethod = (readonlyDb as Record<string, (statement: unknown) => Promise<unknown>>)[method]!;',
            ...
            '  try {',
            "    const transaction = (readonlyDb as { transaction(callback: (tx: unknown) => unknown): unknown })['transaction'];",
            ...
            '  try {',
            '    const denied = (readonlyDb as Record<string, () => unknown>)[method]!;',
