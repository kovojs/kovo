...
describe('create-kovo starter (build integration: production response header artifacts)', () => {
  it(
    'fails closed on unsafe response header values in the production server artifact',
    async () => {
...
function addHeaderSinkProofRoutes(root: string): void {
  ...
  writeFileSync(
    join(root, 'src/header-cookie-mutation.ts'),
    [
      "import { s } from '@kovojs/server';",
      '',
      "import { app } from './kovo.js';",
      '',
      'export const headerCookieProof = app.mutation({',
      "  access: app.publicAccess('public Set-Cookie response header sink proof'),",
  ...
  writeFileSync(
    ...
    [
      ...
      '',
      "import { headerCookieProof } from './header-cookie-mutation.js';",
      '',
  ...
  writeFileSync(
    ...
    [
      ...
      ');',
      '',
      "export const rawHeaderEndpoint = app.endpoint('/raw-header-endpoint', {",
      "  access: app.publicAccess('public raw endpoint Set-Cookie header sink proof'),",
      ...
      '});',
      '',
      "export const rawHeaderTransportEndpoint = app.endpoint('/raw-header-transport', {",
      "  access: app.publicAccess('public raw endpoint transport-header sink proof'),",
      ...
      '});',
      '',
      "export const rawHeaderRedirectEndpoint = app.endpoint('/raw-header-redirect', {",
      "  access: app.publicAccess('public raw endpoint redirect Location header sink proof'),",
  ...
  writeFileSync(
    join(root, 'src/header-route-proof.tsx'),
    [
      '/** @jsxImportSource @kovojs/server */',
      "import { notFound, respond } from '@kovojs/server';",
      '',
      "import { HeaderCookieProof } from './header-cookie-proof.js';",
      "import { app } from './kovo.js';",
      '',
      'export const headerCacheParentLayout = app.layout({ access: [app.authenticated] });',
      'export const headerCacheChildLayout = app.layout({ parent: headerCacheParentLayout });',
      '',
      "export const rollingCookie404 = app.route('/rolling-cookie-404', {",
      "  access: app.publicAccess('rolling-cookie matched 404 cache-floor proof'),",
      '  page() {',
      '    return notFound();',
      '  },',
      '});',
      '',
      "export const rollingCookie200 = app.route('/rolling-cookie-200', {",
      "  access: app.publicAccess('rolling-cookie 200 cache-floor control'),",
      '  page() {',
      '    return <main>rolling cookie 200 control</main>;',
      '  },',
      '});',
      '',
      "export const headerSinkSafe = app.route('/header-sink-safe.txt', {",
      "  access: app.publicAccess('public response header sink proof'),",
      '  page() {',
      ...
      '});',
      '',
      "export const headerNameUnsafe = app.route('/header-name-unsafe.txt', {",
      "  access: app.publicAccess('public response header-name allowlist proof'),",
      ...
      '});',
      '',
      "export const headerTransportUnsafe = app.route('/header-transport-unsafe.txt', {",
      "  access: app.publicAccess('public response transport-header sink proof'),",
      '  page(_context, request) {',
      ...
      '});',
      '',
      "export const headerRouteAccessPrivate = app.route('/header-route-access-private.txt', {",
      ...
      '});',
      '',
      "export const headerParentLayoutAccessPrivate = app.route('/header-parent-layout-access-private.txt', {",
      "  access: app.publicAccess('parent layout owns private access proof'),",
      ...
      '});',
      '',
      "export const headerPublicCacheControl = app.route('/header-public-cache-control.txt', {",
      "  access: app.publicAccess('public cache posture control'),",
      '  page() {',
      ...
      '});',
      '',
      "export const headerSinkUnsafe = app.route('/header-sink-unsafe.txt', {",
      "  access: app.publicAccess('public response header sink proof'),",
      '  page() {',
      ...
      '});',
      '',
      "export const headerStreamSafe = app.route('/header-stream-safe.bin', {",
      "  access: app.publicAccess('public response stream sink proof'),",
      '  page() {',
      ...
      '});',
      '',
      "export const headerRouteForged = app.route('/header-route-forged.html', {",
      "  access: app.publicAccess('public structural route-response forgery proof'),",
      '  page() {',
      '    return {',
      ...
      '});',
      '',
      "export const headerRouteTypedFile = app.route('/header-route-typed-file.bin', {",
      "  access: app.publicAccess('public typed file route-response artifact proof'),",
      '  page() {',
      ...
      '});',
      '',
      "export const headerRouteOmittedPolicy = app.route('/header-route-omitted-policy.bin', {",
      "  access: app.publicAccess('public omitted route outcome policy artifact proof'),",
      '  page() {',
      ...
      '});',
      '',
      "export const headerCookieProofRoute = app.route('/header-cookie-proof', {",
      "  access: app.publicAccess('public Set-Cookie response header sink proof'),",
      '  page() {',
  ...
  appSource = replaceRequired(
    ...
    [
      ...
      'import {',
      '  headerCacheChildLayout,',
      '  headerCacheParentLayout,',
      '  headerCookieProofRoute,',
      '  headerNameUnsafe,',
      '  headerParentLayoutAccessPrivate,',
      '  headerPublicCacheControl,',
      '  headerRouteAccessPrivate,',
      '  headerRouteForged,',
      '  headerRouteOmittedPolicy,',
      '  headerRouteTypedFile,',
      '  headerSinkSafe,',
      '  headerSinkUnsafe,',
      '  headerStreamSafe,',
      '  headerTransportUnsafe,',
      '  rollingCookie200,',
      '  rollingCookie404,',
      "} from './header-route-proof.js';",
    ].join('\n'),
    'response-header proof declaration imports',
  );
  appSource = replaceRequired(
    appSource,
    '  endpoints: [healthEndpoint],',
    '  endpoints: [healthEndpoint, rawHeaderEndpoint, rawHeaderTransportEndpoint, rawHeaderRedirectEndpoint],',
    'response-header proof endpoint assembly',
  );
  appSource = replaceRequired(
    appSource,
    '  layouts: [AppLayout],',
    '  layouts: [AppLayout, headerCacheParentLayout, headerCacheChildLayout],',
    'response-header proof layout assembly',
  );
  appSource = replaceRequired(
    appSource,
    '  mutations: [addContact, signInMutation, signOutMutation],',
    '  mutations: [addContact, headerCookieProof, signInMutation, signOutMutation],',
    'response-header proof mutation assembly',
  );
  appSource = replaceRequired(
    appSource,
    ...
    'response-header proof route assembly',
  );
  writeFileSync(appPath, appSource, 'utf8');
  formatGeneratedProjectSources(root, [
    'src/app.tsx',
    'src/auth.ts',
    'src/header-cookie-mutation.ts',
    'src/header-cookie-proof.tsx',
    'src/header-raw-proof.ts',
    'src/header-route-proof.tsx',
  ]);
}
