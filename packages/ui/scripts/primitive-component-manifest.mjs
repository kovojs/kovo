...
export const primitiveComponentManifest = {
  ...
  headlessPrimitives: [
    ...
    {
      handlers: ['avatarImageError', 'avatarImageLoad'],
      subpath: 'avatar',
    },
    {
      handlers: ['checkboxTriggerClick'],
      subpath: 'checkbox',
    },
    {
      handlers: ['checkboxGroupItemClick', 'checkboxGroupKeyDown'],
      subpath: 'checkbox-group',
    },
    {
      handlers: ['collapsibleTriggerClick'],
      subpath: 'collapsible',
    },
    {
    ...
    {
      handlers: ['dialogBeforeToggle', 'dialogCancel', 'dialogCloseClick', 'dialogTriggerClick'],
      subpath: 'dialog',
    },
    {
      handlers: ['disclosureTriggerClick'],
      subpath: 'disclosure',
    },
    {
    ...
    {
      handlers: ['otpFieldInput', 'otpFieldKeyDown', 'otpFieldPaste'],
      subpath: 'otp-field',
    },
    {
      handlers: ['popoverBeforeToggle', 'popoverEscapeKeyDown', 'popoverTriggerClick'],
      subpath: 'popover',
    },
    {
      handlers: [],
    ...
    {
      handlers: ['radioGroupItemClick', 'radioGroupKeyDown'],
      subpath: 'radio-group',
    },
    {
    ...
    {
      handlers: ['switchTriggerClick'],
      subpath: 'switch',
    },
    {
      handlers: ['tabsKeyDown', 'tabsTriggerClick'],
      subpath: 'tabs',
    },
    {
    ...
    {
      handlers: ['toggleTriggerClick'],
      subpath: 'toggle',
    },
    {
      handlers: ['toggleGroupItemClick', 'toggleGroupKeyDown'],
      subpath: 'toggle-group',
    },
    {
      handlers: ['toolbarKeyDown'],
      subpath: 'toolbar',
    },
    {
      handlers: [
