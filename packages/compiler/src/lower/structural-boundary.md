...
| `navigationHrefLowering`           | `navigation.ts`        | `legacy-structural-entrypoint` | Legacy full source-patch entrypoint retained for direct lowerer tests. The production compile path routes JSX `href` attribute lowering through `lowerStructuralJsx`; do not add production call sites.                                                                                                                                                                      |
