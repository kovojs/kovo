...
function normalizeDiagnosticHelp(help: string): string {
  return help.replaceAll(/\/c\/__v\/[0-9a-f]{64}\//g, '/c/__v/<representation-digest>/');
}
      ...
      [
        {
          "code": "KV201",
          "fileName": "cart-badge.tsx",
          "help": "Would lower to: on:click="/c/__v/<representation-digest>/cart-badge.client.js#CartBadge$button_click"
