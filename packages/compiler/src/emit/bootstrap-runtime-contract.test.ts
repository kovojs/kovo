 ...
 * compiler emits imports named *values* from `@kovojs/browser/generated`. This test resolves
...
describe('emitted bootstrap ↔ @kovojs/browser/generated import contract', () => {
  it('imports only value names the published @kovojs/browser/generated barrel exports', () => {
    ...
    expect(
      missing,
      `emitted bootstrap imports names absent from @kovojs/browser/generated: ${missing.join(', ')}`,
    ).toEqual([]);
  });
});
