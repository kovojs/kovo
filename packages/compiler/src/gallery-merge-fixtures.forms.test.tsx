...
describe('gallery G5 primitive merge fixtures', () => {
  ...
  it('renders a golden select merge with custom trigger and option scalars', () => {
    ...
    expect(
      ...
      '<button data-state="open" data-required="" role="combobox" type="button" aria-expanded="true" aria-haspopup="listbox" aria-controls="gallery-select-listbox" aria-labelledby="gallery-select-label" id="gallery-select" class="select-trigger min-w-40" name="author-plan"><div data-state="checked" aria-selected="true" role="option" id="gallery-select-listbox-option-1" value="author-growth" label="Author Growth" class="select-option font-medium">Growth</div></button>',
    );
  });
