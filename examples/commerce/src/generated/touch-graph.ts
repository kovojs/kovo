    ...
    "touches": [
      {
        "domain": "cart",
        "keys": null,
        "site": "examples/commerce/src/app.ts:468",
        "via": "cart_items"
      },
      {
        "domain": "order",
        "keys": null,
        "site": "examples/commerce/src/app.ts:473",
        "via": "orders"
      },
      {
        "domain": "product",
        "keys": "arg:productId",
        "predicate": "eq",
        "site": "examples/commerce/src/app.ts:481",
        "via": "products"
      }
    ],
    "reads": [],
    ...
    "touches": [
      {
        ...
        "predicate": "eq",
        "site": "examples/commerce/src/app.ts:624",
        "via": "orders"
      }
    ],
    "reads": [],
    ...
    "touches": [
      {
        ...
        "keys": "arg:orderId",
        "predicate": "eq",
        "site": "examples/commerce/src/app.ts:545",
        "via": "attachments"
      }
    ],
    "reads": [],
