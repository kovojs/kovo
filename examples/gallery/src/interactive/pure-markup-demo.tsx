...
export const GalleryPureMarkupDemo = component({
  ...
  render: (_queries: Record<string, never>, state: GalleryPureMarkupDemoState) => (
    <section style="display:grid;gap:1rem" data-gallery-interactive="pure-markup">
      ...
      <Table>
        <thead style="border-bottom:1px solid var(--edge,#e5e5e5);background:var(--panel,#fafafa)">
          <tr style="border-bottom:1px solid var(--edge,#e5e5e5)">
            <th
              style="height:2.5rem;padding:0 0.75rem;text-align:left;vertical-align:middle;font-weight:500;color:var(--dim,#404040)"
              scope="col"
            >
              Surface
            </th>
        ...
        <tbody>
          <tr style="border-bottom:1px solid var(--edge,#e5e5e5)">
            <td style="padding:0.75rem;vertical-align:middle;color:var(--ink,#0a0a0a)">
              Card and badge
            </td>
            <td style="padding:0.75rem;vertical-align:middle;color:var(--ink,#0a0a0a)">compiled</td>
          </tr>
          <tr style="border-bottom:1px solid var(--edge,#e5e5e5)">
            <td style="padding:0.75rem;vertical-align:middle;color:var(--ink,#0a0a0a)">
