...
const expectedBehaviorSnippets: Partial<Record<GalleryRoute['path'], readonly string[]>> = {
  ...
  '/components/drawer': [
    ...
    '<dialog class=',
    'aria-describedby="gallery-drawer-description"',
    'aria-modal="true"',
    'id="gallery-drawer" open role="dialog"',
    'data-style-src="drawer.tsx#content; drawer.tsx#bottom"',
  ...
  '/components/field': [
    ...
    'pattern=".+@example\\.com"',
    '<textarea class=',
    'aria-describedby="gallery-field-bio-description"',
    'autoComplete="off"',
    'maxLength="240"',
    '<select class=',
    'aria-describedby="gallery-field-plan-description"',
    'selected value="team">Team</option>',
  ...
  '/components/select': [
    ...
    'role="listbox"',
    'role="option"',
    'id="gallery-select-hidden" name="gallery-plan" type="hidden" value="growth"',
    'aria-selected="true"',
    'aria-disabled="true"',
  ...
  '/components/sheet': [
    ...
    '<dialog class=',
    'aria-describedby="gallery-sheet-description"',
    'aria-modal="true"',
    'id="gallery-sheet" open role="dialog"',
