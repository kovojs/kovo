  ...
  render: (_queries: Record<string, never>, state: GalleryToastDemoState) => {
    ...
    return (
      <section
        ...
        on:keydown="/c/examples/gallery/src/generated/interactive/toast-demo.client.js?v=05b3f06b#GalleryToastDemo$section_keydown"
      ...
      >
        ...
        <button
          ...
          data-toast-show=""
          type="button"
          on:click="/c/examples/gallery/src/generated/interactive/toast-demo.client.js?v=05b3f06b#GalleryToastDemo$button_click"
        >
          Show toast
        </button>
        <div
          ...
          data-bind:data-state="/c/examples/gallery/src/generated/interactive/toast-demo.client.js?v=05b3f06b#GalleryToastDemo$div_data_state_derive"
          hidden={!state.previousOpen}
          data-bind:hidden="/c/examples/gallery/src/generated/interactive/toast-demo.client.js?v=05b3f06b#GalleryToastDemo$div_hidden_derive"
        >
          <strong
            class={TITLE_CLASS}
          ...
          <p
            ...
            data-bind="/c/examples/gallery/src/generated/interactive/toast-demo.client.js?v=05b3f06b#GalleryToastDemo$p_text_derive"
          >
            {'Gallery settings update #' + state.previousCount}
          </p>
          <button
            class={CLOSE_CLASS}
            on:click="/c/examples/gallery/src/generated/interactive/toast-demo.client.js?v=05b3f06b#GalleryToastDemo$button_click_2"
            {...toastCloseAttributes(previousToastState)}
            data-state={state.previousOpen ? 'open' : 'closed'}
            data-bind:data-state="/c/examples/gallery/src/generated/interactive/toast-demo.client.js?v=05b3f06b#GalleryToastDemo$button_data_state_derive"
          >
            Dismiss
          </button>
        </div>
        <div
          ...
          on:animationend="/c/examples/gallery/src/generated/interactive/toast-demo.client.js?v=05b3f06b#GalleryToastDemo$div_animationend"
          {...toastRootAttributes(activeToastState)}
          data-state={state.activeOpen ? 'open' : 'closed'}
          data-bind:data-state="/c/examples/gallery/src/generated/interactive/toast-demo.client.js?v=05b3f06b#GalleryToastDemo$div_data_state_derive_2"
          hidden={!state.activeOpen}
          data-bind:hidden="/c/examples/gallery/src/generated/interactive/toast-demo.client.js?v=05b3f06b#GalleryToastDemo$div_hidden_derive_2"
        >
          ...
          <p
            ...
            data-bind="/c/examples/gallery/src/generated/interactive/toast-demo.client.js?v=05b3f06b#GalleryToastDemo$p_text_derive_2"
          >
            {'Gallery settings update #' + state.activeCount}
          </p>
          <button
            class={ACTION_CLASS}
            on:click="/c/examples/gallery/src/generated/interactive/toast-demo.client.js?v=05b3f06b#GalleryToastDemo$button_click_3"
          ...
          <button
            ...
            on:click="/c/examples/gallery/src/generated/interactive/toast-demo.client.js?v=05b3f06b#GalleryToastDemo$button_click_4"
            {...toastActionAttributes({
              ...activeToastState,
          ...
          <button
            class={CLOSE_CLASS}
            on:click="/c/examples/gallery/src/generated/interactive/toast-demo.client.js?v=05b3f06b#GalleryToastDemo$button_click_5"
            {...toastCloseAttributes(activeToastState)}
            data-state={state.activeOpen ? 'open' : 'closed'}
            data-bind:data-state="/c/examples/gallery/src/generated/interactive/toast-demo.client.js?v=05b3f06b#GalleryToastDemo$button_data_state_derive_2"
          >
            Dismiss
          </button>
          <button
            ...
            on:click="/c/examples/gallery/src/generated/interactive/toast-demo.client.js?v=05b3f06b#GalleryToastDemo$button_click_6"
            {...toastActionAttributes({
              ...activeToastState,
              actionValue: 'blocked',
              disabled: true,
        ...
        <output
          ...
          data-bind="/c/examples/gallery/src/generated/interactive/toast-demo.client.js?v=05b3f06b#GalleryToastDemo$output_text_derive"
        >
          {state.activeOpen ? 'open' : state.previousOpen ? 'stacked' : 'empty'}
        </output>
