...
export const GalleryCheckboxGroupDemo$input_click_3 = handler((event, ctx) => {
  const result = _checkboxGroupItemClick(Object(event), {
    itemValue: 'billing',
    items: [{ value: 'updates' }, { value: 'billing' }],
    value:
...
export const GalleryCheckboxGroupDemo$input_aria_checked_derive_2 = derive(['state'], (state) =>
  String(state.value === 'updates' || state.value === 'updates,billing'),
);
export const GalleryCheckboxGroupDemo$input_checked_derive_2 = derive(['state'], (state) =>
  state.value === 'updates' || state.value === 'updates,billing' ? '' : null,
);
export const GalleryCheckboxGroupDemo$input_data_state_derive_2 = derive(['state'], (state) =>
  state.value === 'updates' || state.value === 'updates,billing' ? 'checked' : 'unchecked',
);
export const GalleryCheckboxGroupDemo$label_data_state_derive = derive(['state'], (state) =>
  state.value === 'updates' || state.value === 'updates,billing' ? 'checked' : 'unchecked',
);
export const GalleryCheckboxGroupDemo$input_aria_checked_derive_3 = derive(['state'], (state) =>
  String(state.value === 'billing' || state.value === 'updates,billing'),
);
export const GalleryCheckboxGroupDemo$input_checked_derive_3 = derive(['state'], (state) =>
  state.value === 'billing' || state.value === 'updates,billing' ? '' : null,
);
export const GalleryCheckboxGroupDemo$input_data_state_derive_3 = derive(['state'], (state) =>
  state.value === 'billing' || state.value === 'updates,billing' ? 'checked' : 'unchecked',
);
export const GalleryCheckboxGroupDemo$label_data_state_derive_2 = derive(['state'], (state) =>
  state.value === 'billing' || state.value === 'updates,billing' ? 'checked' : 'unchecked',
);
