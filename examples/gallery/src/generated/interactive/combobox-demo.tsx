  ...
  render: (_queries: Record<string, never>, state: GalleryComboboxDemoState) => {
    ...
    return (
      <section
        ...
        data-bind:data-state="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$section_data_state_derive"
      ...
      >
        ...
        <input
          ...
          class={INPUT_CLASS}
          on:input="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$input_input"
          on:keydown="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$input_keydown"
          {...comboboxInputAttributes({
            ...inputState,
            id: 'gallery-combobox-input',
          ...
          data-bind:aria-activedescendant="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$input_aria_activedescendant_derive"
          aria-expanded={state.open ? 'true' : 'false'}
          data-bind:aria-expanded="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$input_aria_expanded_derive"
          data-placeholder={state.inputValue === '' ? '' : null}
          data-bind:data-placeholder="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$input_data_placeholder_derive"
          data-state={state.open ? 'open' : 'closed'}
          data-bind:data-state="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$input_data_state_derive"
          value={state.inputValue}
          data-bind:value="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$input_value_derive"
        />
        <div
          class={LISTBOX_CLASS}
          {...comboboxListboxAttributes({
          ...
          data-state={state.open ? 'open' : 'closed'}
          data-bind:data-state="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$div_data_state_derive"
          hidden={!state.open}
          data-bind:hidden="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$div_hidden_derive"
        >
          <button
            class={OPTION_CLASS}
            on:click="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$button_click"
            {...comboboxOptionAttributes({
              ...selectedState,
            ...
            data-bind:aria-selected="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$button_aria_selected_derive"
            data-highlighted={state.highlightedValue === 'austin' ? '' : null}
            data-bind:data-highlighted="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$button_data_highlighted_derive"
            data-state={state.value === 'austin' ? 'checked' : 'unchecked'}
            data-bind:data-state="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$button_data_state_derive"
            hidden={
              state.inputValue !== '' &&
              !'austin austin'.includes(state.inputValue.toLocaleLowerCase())
            }
            data-bind:hidden="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$button_hidden_derive"
            tabIndex={state.highlightedValue === 'austin' ? 0 : -1}
            data-bind:tabIndex="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$button_tabIndex_derive"
          >
            Austin
          </button>
          <button
            ...
            data-bind:aria-selected="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$button_aria_selected_derive_2"
            data-highlighted={state.highlightedValue === 'boston' ? '' : null}
            data-bind:data-highlighted="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$button_data_highlighted_derive_2"
            data-state={state.value === 'boston' ? 'checked' : 'unchecked'}
            data-bind:data-state="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$button_data_state_derive_2"
            hidden={
              state.inputValue !== '' &&
              !'boston boston'.includes(state.inputValue.toLocaleLowerCase())
            }
            data-bind:hidden="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$button_hidden_derive_2"
          >
            Boston
          </button>
          <button
            class={OPTION_CLASS}
            on:click="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$button_click_2"
            {...comboboxOptionAttributes({
              ...selectedState,
            ...
            data-bind:aria-selected="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$button_aria_selected_derive_3"
            data-highlighted={state.highlightedValue === 'chicago' ? '' : null}
            data-bind:data-highlighted="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$button_data_highlighted_derive_3"
            data-state={state.value === 'chicago' ? 'checked' : 'unchecked'}
            data-bind:data-state="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$button_data_state_derive_3"
            hidden={
              state.inputValue !== '' &&
              !'chicago city chicago'.includes(state.inputValue.toLocaleLowerCase())
            }
            data-bind:hidden="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$button_hidden_derive_3"
            tabIndex={state.highlightedValue === 'chicago' ? 0 : -1}
            data-bind:tabIndex="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$button_tabIndex_derive_2"
          >
            Chicago city
          </button>
        </div>
        <output
          ...
          data-bind="/c/examples/gallery/src/generated/interactive/combobox-demo.client.js?v=7a7c3fa1#GalleryComboboxDemo$output_text_derive"
        >
          {state.value === 'chicago' ? 'Chicago city' : 'Austin'}
        </output>
      </section>
