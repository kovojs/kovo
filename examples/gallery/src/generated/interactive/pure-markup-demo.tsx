// @jiso-ir - lowered from examples/gallery/src/interactive/pure-markup-demo.tsx by @jiso/compiler (SPEC.md section 5.2). Do not edit; regenerate with `pnpm run emit:interactive-gallery`.
...
export const GalleryPureMarkupDemo = component('gallery-pure-markup-demo', {
  ...
  render: (_queries: Record<string, never>, state: GalleryPureMarkupDemoState) => (
    <section
      ...
      fw-c="gallery-pure-markup-demo"
      fw-state='{"submitted":false}'
    >
      <section
      ...
      >
        ...
        <form id="gallery-pure-markup-form">
          <button
            ...
            type="button"
            on:click="/c/examples/gallery/src/generated/interactive/pure-markup-demo.client.js?v=38e9c1f9#GalleryPureMarkupDemo$button_click"
          >
            Confirm
          </button>
        </form>
        <output
          ...
          data-bind="/c/examples/gallery/src/generated/interactive/pure-markup-demo.client.js?v=38e9c1f9#GalleryPureMarkupDemo$output_text_derive"
        >
          {state.submitted ? 'confirmed' : 'pending'}
        </output>
      </section>
