  ...
  render: (_queries: Record<string, never>, state: GalleryContextMenuDemoState) => {
    ...
    return (
      <section
        ...
        data-bind:data-state="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$section_data_state_derive"
      ...
      >
        <div
          ...
          on:contextmenu="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$div_contextmenu"
          on:keydown="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$div_keydown"
          tabIndex="0"
          {...contextMenuTriggerAttributes({ ...menuState, contentId })}
          aria-expanded={state.open ? 'true' : 'false'}
          data-bind:aria-expanded="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$div_aria_expanded_derive"
          data-state={state.open ? 'open' : 'closed'}
          data-bind:data-state="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$div_data_state_derive"
        >
          Right click target
        </div>
        <div
          ...
          data-bind:data-anchor-x="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$div_data_anchor_x_derive"
          data-anchor-y={String(state.point.y)}
          data-bind:data-anchor-y="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$div_data_anchor_y_derive"
          data-state={state.open ? 'open' : 'closed'}
          data-bind:data-state="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$div_data_state_derive_2"
          hidden={!state.open}
          data-bind:hidden="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$div_hidden_derive"
        >
          <button
            class={ITEM_CLASS}
            on:keydown="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$button_keydown"
            on:click="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$button_click"
            {...contextMenuItemAttributes({
              ...menuState,
            ...
            data-bind:data-highlighted="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$button_data_highlighted_derive"
            data-state={state.highlightedValue === 'copy' ? 'active' : 'inactive'}
            data-bind:data-state="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$button_data_state_derive"
            tabIndex={state.highlightedValue === 'copy' ? 0 : -1}
            data-bind:tabIndex="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$button_tabIndex_derive"
          >
            Copy link
          </button>
          <button
          ...
          <button
            class={ITEM_CLASS}
            on:keydown="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$button_keydown_2"
            on:click="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$button_click_2"
            {...contextMenuItemAttributes({
              ...menuState,
            ...
            data-bind:data-highlighted="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$button_data_highlighted_derive_2"
            data-state={state.highlightedValue === 'inspect' ? 'active' : 'inactive'}
            data-bind:data-state="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$button_data_state_derive_2"
            tabIndex={state.highlightedValue === 'inspect' ? 0 : -1}
            data-bind:tabIndex="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$button_tabIndex_derive_2"
          >
            Inspect
          </button>
        </div>
        <output
          ...
          data-bind="/c/examples/gallery/src/generated/interactive/context-menu-demo.client.js?v=ff013dad#GalleryContextMenuDemo$output_text_derive"
        >
          {state.open ? 'open' : 'closed'}
        </output>
