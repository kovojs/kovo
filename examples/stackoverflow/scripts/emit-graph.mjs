...
const mutationTouchRegistrySource = staticGraphArtifacts.mutationTouchRegistrySource;
...
registerGeneratedQueryReadRegistry(soQueryDomains);

${invalidationRegistrySource}
${mutationTouchRegistrySource}
...
function compileDrizzleOptimistic(input) {
  ...
  runKovo(['compile', 'drizzle-optimistic', inputPath, '--out', input.outPath]);
}
